 ...
 */
public class ChargeCardItemDao implements Parcelable {
    ...
    public ChargeCardItemDao() {
    }

    protected ChargeCardItemDao(Parcel in) {
        this.crm_accounts_get = in.readParcelable(CrmAccountsGetEntity.class.getClassLoader());
    }

    public static final Parcelable.Creator<ChargeCardItemDao> CREATOR = new Parcelable.Creator<ChargeCardItemDao>() {
        @Override
        public ChargeCardItemDao createFromParcel(Parcel source) {
            return new ChargeCardItemDao(source);
        }

        @Override
        public ChargeCardItemDao[] newArray(int size) {
            return new ChargeCardItemDao[size];
        }
    };
}
